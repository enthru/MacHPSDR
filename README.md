...
- **Automatic LNB drift correction.** An LNB's local oscillator is a
  ...
  **middle** one at 10489.750. It is 400 bd BPSK, i.e. a suppressed carrier with
  ...
  its two tones. The two CW beacons at the band edges are offered too; the
  wideband beacon is DVB-S2 and the lock refuses it, since it is there for the
  level reference line above.
