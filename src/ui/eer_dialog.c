...
GtkWidget *create_eer_dialog(RADIO *r) {
  ...
  gtk_widget_set_visible(eer_mgain_label, TRUE);
  ...
  gtk_widget_set_visible(eer_mgain, TRUE);
  ...
  gtk_widget_set_visible(eer_pdelay_label, TRUE);
  ...
  gtk_widget_set_visible(eer_pdelay, TRUE);
  ...
  gtk_widget_set_visible(eer_pgain_label, TRUE);
  ...
  gtk_widget_set_visible(eer_pgain, TRUE);
  ...
  gtk_widget_set_visible(eer_mdelay_label, TRUE);
  ...
  gtk_widget_set_visible(eer_mdelay, TRUE);
  ...
  gtk_widget_set_visible(eer_pwm_max_label, TRUE);
  ...
  gtk_widget_set_visible(eer_pwm_max, TRUE);
  ...
  gtk_widget_set_visible(eer_pwm_min_label, TRUE);
  ...
  gtk_widget_set_visible(eer_pwm_min, TRUE);
