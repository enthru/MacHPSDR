...
log_info("radio_save_state: %s\n",filename);
  ...
  sprintf(value,"%f",radio->wefax_contrast);
  setProperty("radio.wefax_contrast",value);
  sprintf(value,"%f",radio->wefax_brightness);
  setProperty("radio.wefax_brightness",value);
